...
def parse_commandline_args():
	...
	parser.add_argument('--frappe-repo-url', dest='frappe_repo_url', action='store', default='https://gitlab.com/inmotiongroup/frappe-tw.git', help='Clone frappe from the given url')
	parser.add_argument('--frappe-branch', dest='frappe_branch', action='store', help='Clone a particular branch of frappe')
	parser.add_argument('--erpnext-repo-url', dest='erpnext_repo_url', action='store', default='https://gitlab.com/inmotiongroup/erpnext-tw.git', help='Clone erpnext from the given url')
